...
if (currentURL.includes("index")) {
    listingsLI.classList.add("bg-white", "text-blue", "py-10", "px-6", "shadow-xl")
}

if (currentURL.includes("myprofile")) {
    myprofileLI.classList.add("bg-white", "text-blue", "py-10", "px-6", "shadow-xl")
}

if (currentURL.includes("newlisting")) {
    newlistingLi.classList.add("bg-white", "text-blue", "py-10", "px-6", "shadow-xl")
}
